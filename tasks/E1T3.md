# E1T3 — Profile View Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement the 'View Profile' inline button (callback_data: profile:view) in src/handlers/profile.ts. Display user stats (rating, wins, losses, accuracy) and provide a 'Back to Menu' button. Write tests/specs/profile.json for profile display validation.
