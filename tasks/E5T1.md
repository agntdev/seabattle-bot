# E5T1 — Invite Code Handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Implement invite code parsing in src/handlers/invite.ts when users open t.me/YourBot?start=invite_<code>. Create a pending match and notify both players. Write tests/specs/invite-handling.json for deep-link validation.
