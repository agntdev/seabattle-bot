# E6T1 — Manual Ship Placement

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 SBOT

Create a 10x10 inline keyboard in src/handlers/ship-placement.ts for selecting cells. Implement ship type selection, rotation, and placement confirmation. Write tests/specs/ship-placement.json for grid interaction validation.
